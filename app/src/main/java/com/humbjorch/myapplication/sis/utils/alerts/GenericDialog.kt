...
import com.humbjorch.myapplication.databinding.FragmentGenericDialogBinding
import com.humbjorch.myapplication.sis.utils.setSafeOnClickListener
...
class GenericDialog : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentGenericDialogBinding.inflate(LayoutInflater.from(context), container, false)
        return binding.root
    }
    ...
    private fun initComponents() {
        binding.imgGeneric.setImageDrawable(AppCompatResources.getDrawable(requireContext(), imgDialog!!))
